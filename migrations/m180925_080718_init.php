...
class m180925_080718_init extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('{{%support_ticket_head}}', [
            ...
            'category_id' => $this->integer()->null()->defaultValue(null)->unsigned(),
            'title' => $this->string()->notNull(),
            ...
            'user_id' => $this->integer()->null()->defaultValue(null)->unsigned(),
            'created_at' => $this->integer()->notNull()->unsigned(),
            'updated_at' => $this->integer()->notNull()->unsigned(),
        ], $tableOptions);
        ...
        $this->addForeignKey(
            ...
            '{{%support_ticket_head}}',
            'user_id',
            $this->getModule()->userModel::tableName(),
            $this->getModule()->userPK,
            'CASCADE',
            'CASCADE'
        );
        ...
        $this->createTable('{{%support_ticket_content}}', [
            'id' => $this->primaryKey(11)->unsigned(),
            'id_ticket' => $this->integer()->notNull()->unsigned(),
    ...
    {
        $this->dropForeignKey(
            '{{%fk_support_ticket_content_user_id-core_account_id}}',
            '{{%support_ticket_content}}'
        );
        $this->dropForeignKey(
            '{{%fk_support_ticket_content_id-support_ticket_head_id}}',
        ...
        $this->dropForeignKey(
            '{{%fk_support_ticket_head_user_id-core_account_id}}',
            '{{%support_ticket_head}}'
        );
